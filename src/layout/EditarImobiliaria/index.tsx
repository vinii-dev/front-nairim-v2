...
import {
  ...
  Home, Building, MapPin as MapPinIcon,
  Phone as PhoneIcon, Mail as MailIcon, CheckCircle
} from 'lucide-react';

interface EditarImobiliariaPageClientProps {
  id: string;
}

export default function EditarImobiliariaPageClient({ id }: EditarImobiliariaPageClientProps) {
